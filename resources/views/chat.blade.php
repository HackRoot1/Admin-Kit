                    ...
                    <div class="col-12 col-lg-5 col-xl-3 border-end list-group">
                        ...
                        <a href="#" class="list-group-item list-group-item-action border-0">
                            ...
                            <div class="d-flex align-items-start">
                                <img src="img/avatars/avatar-5.jpg" class="rounded-circle me-1" alt="Vanessa Tucker"
                                    width="40" height="40">
                        ...
                        <a href="#" class="list-group-item list-group-item-action border-0">
                            ...
                            <div class="d-flex align-items-start">
                                <img src="img/avatars/avatar-2.jpg" class="rounded-circle me-1" alt="William Harris"
                                    width="40" height="40">
                                <div class="flex-grow-1 ms-3">
                                    William Harris
                                    <div class="small"><span class="fas fa-circle chat-online"></span> Online</div>
                        ...
                        <a href="#" class="list-group-item list-group-item-action border-0">
                            <div class="d-flex align-items-start">
                                <img src="img/avatars/avatar-3.jpg" class="rounded-circle me-1" alt="Sharon Lessman"
                                    width="40" height="40">
                                <div class="flex-grow-1 ms-3">
                                    Sharon Lessman
                                    <div class="small"><span class="fas fa-circle chat-online"></span> Online</div>
                        ...
                        <a href="#" class="list-group-item list-group-item-action border-0">
                            <div class="d-flex align-items-start">
                                <img src="img/avatars/avatar-4.jpg" class="rounded-circle me-1" alt="Christina Mason"
                                    width="40" height="40">
                                <div class="flex-grow-1 ms-3">
                                    Christina Mason
                        ...
                        <a href="#" class="list-group-item list-group-item-action border-0">
                            <div class="d-flex align-items-start">
                                <img src="img/avatars/avatar-5.jpg" class="rounded-circle me-1" alt="Fiona Green"
                                    width="40" height="40">
                                <div class="flex-grow-1 ms-3">
                                    Fiona Green
                                    <div class="small"><span class="fas fa-circle chat-offline"></span> Offline</div>
                        ...
                        <a href="#" class="list-group-item list-group-item-action border-0">
                            <div class="d-flex align-items-start">
                                <img src="img/avatars/avatar-2.jpg" class="rounded-circle me-1" alt="Doris Wilder"
                                    width="40" height="40">
                                <div class="flex-grow-1 ms-3">
                                    Doris Wilder
                                    <div class="small"><span class="fas fa-circle chat-offline"></span> Offline</div>
                        ...
                        <a href="#" class="list-group-item list-group-item-action border-0">
                            <div class="d-flex align-items-start">
                                <img src="img/avatars/avatar-4.jpg" class="rounded-circle me-1" alt="Haley Kennedy"
                                    width="40" height="40">
                                <div class="flex-grow-1 ms-3">
                                    Haley Kennedy
                                    <div class="small"><span class="fas fa-circle chat-offline"></span> Offline</div>
